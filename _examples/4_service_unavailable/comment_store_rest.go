...
// CommentStoreEndpoints return CURD endpoints for CommentStore
func CommentStoreEndpoints(noun, nounp string) (endpoints map[string]endpoint.Endpoint) {

	// variables to use later
	allocEntity := func() *Comment { return &Comment{} }
	allocEntityList := func() *[]Comment { return &[]Comment{} }
	getStore := GetCommentStore
...
// CommentStoreRest binds store to pat router
func CommentStoreRest(r *pat.Router, p perm.Mux, base, noun, nounp string) {
	...
	endpoints := CommentStoreEndpoints(noun, nounp)
